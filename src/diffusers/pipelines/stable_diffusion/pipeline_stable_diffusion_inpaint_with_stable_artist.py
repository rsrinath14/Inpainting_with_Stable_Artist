...
class StableDiffusionInpaintPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        # self.new_unet = UNet2DConditionModel(in_channels=9, sample_size=64, cross_attention_dim = 768).to("cuda")        
    ...
    def __call__(
        ...
        **kwargs,
        ...
        for i, t in enumerate(self.progress_bar(timesteps_tensor)):
            ...
            mask_input = (
                torch.cat([mask] * (2 + enabled_editing_prompts)) if do_classifier_free_guidance else mask
            )

            masked_image_latents_input = (
                torch.cat([masked_image_latents] * (2 + enabled_editing_prompts)) if do_classifier_free_guidance else masked_image_latents
            )
        ...
        return image
        # return StableDiffusionInpaintPipeline(images=image, inappropriate_content_detected=has_nsfw_concept)
